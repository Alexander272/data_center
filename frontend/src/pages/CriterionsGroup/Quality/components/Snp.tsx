...
const empty: IQualityDTO[] = [
	{ count: 1, title: 'Пропуск наполнителя', number: null, time: null },
	{ count: 2, title: 'Царапины', number: null, time: null },
	{ count: 3, title: 'Неверная гравировка', number: null, time: null },
...
export const Snp = () => {
	...
	const { data } = useGetQualityByPeriodQuery({ product, period: { from: date } }, { skip: !date })
